...
CRect winRect;   GetWindowRect(&winRect);   toolBar.initialize(winRect);
  ...
  toolBar.installMenu(    ID_Menu1, IDR_PopupMenu1, _T("Expandable Operations"));
  toolBar.installMenu(    ID_Menu2, IDR_PopupMenu2, _T("ExpandableP Operations"));
  toolBar.installMenu(ID_SavePopup, IDR_SavePopup,  3);
  }
